        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                    ...
                    <li><router-link :to="{name: 'mountain-list'}">Mountain</router-link></li>
                    <li><router-link :to="{name: 'chat'}">Chat</router-link></li>
                    <li><router-link :to="{name: 'my-pms'}">Private Message</router-link></li>
...
export default {
  ...
  methods: {
    handleLogout () {
      const postData = {
        email: this.$store.state.userStore.authUser.email
      }
      console.log('MAIL:', postData.email)
      this.$http.post('http://localhost:8000/api/auth/logoutWithEmail', postData)
        .then(
          response => {
